...
const Chat: React.FC<ChatProps> = ({
  ...
  // Hardcoded employee names for dropdown
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      if (selectedFile) {
        ...
        const uploadResponse = await fetch("/api/drive", {
          method: "POST",
          body: formData,
        });
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-300 bg-white shadow-lg">
            ...
            <div className="flex items-center space-x-2 animate-fadeIn">
              ...
              <select
                ...
                className="p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
              >
