...
import WebsiteForm from '@/components/forms/WebChatbot';
      ...
      {!isProcced ? (
        <div className='p-8'>
          ...
          >
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full bg-white border border-gray-200">
                <thead>
                  <tr>
                    <th className="px-6 border-r border-b border-gray-200 text-center text-md font-semibold text-black">Key Features</th>
                    {pricingOptions.map((plan) => (
                      <th
                        ...
                        style={{ width: '20%' }} // Equal width for each column
                      >
                      ...
                      {pricingOptions.map((plan) => (
                        ...
                        >
                          {plan.features.includes(feature) ? (
                            <svg
                              className="w-4 h-4 mx-auto text-[#EB6C33]"
          ...
          <div className="mt-6 mb-4">
            <h3 className="text-xl font-semibold ">Next Step: Business Form</h3>
